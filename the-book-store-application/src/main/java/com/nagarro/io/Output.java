...
public class Output {
    public static void displayBooks(List<Book> books) {
        ...
        System.out.println("-----------------------------------------------------------------------------------------------------------------------------------------------");
        System.out.printf("%-10s %-25s %-15s %-50s %-30s %s\n", "ISBN","Book Name", "Book Author", "Description", "Time Of Arrival", "Quantity");
        System.out.println("-----------------------------------------------------------------------------------------------------------------------------------------------");
        while(iterator.hasNext()) {
            Book book = iterator.next();
            System.out.printf("%-10s %-25s %-15s %-50s %-30s %s\n", book.getIsbn(),book.getBookName(), book.getAuthorName(), book.getDescription(), book.getArrivalTime(), book.getQuantity());
        }
        System.out.println("-----------------------------------------------------------------------------------------------------------------------------------------------");
    }
